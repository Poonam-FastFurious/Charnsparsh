...
function Footer() {
  return (
    <>
      <footer className="font-sans tracking-wide py-10  lg:px-72 px-10 bg-footer">
        <div className="grid max-sm:grid-cols-1 lg:grid-cols-3 items-center gap-8">
          <h2 className="lg:col-span-2 text-xl font-semibold text-black">
            ...
            Libero, laudantium eveniet? Autem?
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-[black] font-semibold text-lg mb-6">Support</h4>
            <ul className="space-y-2">
              <li>
                <Link
                  to="#"
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li className="flex items-center">
                ...
                <Link to="#" className="text-black text-sm ml-3">
